...
const eventMenus = [
  { event: '부대개방행사', items: ['커피차', '간식차', '츄러스', '닭강정', '분식'] },
  { event: '체육대회', items: ['커피차', '간식차', '츄러스', '아이스크림', '닭강정', '닭꼬치', '분식'] },
  { event: '각종 훈련', items: ['커피차', '간식차', '아이스크림', '분식'] },
  { event: '지휘관 이취임식, 신병교육대 입퇴소식', items: ['커피차', '간식차', '디저트류'] },
]
